  ...
  return (
    <section className="flex flex-col faq py-10 lg:py-20">
      <div className="container mx-auto flex flex-col">
        {/* Column Category */}
        <h2 className="text-darkblue text-[25px] lg:text-[40px] leading-[1.2] font-normal font-raleway mb-4 lg:mb-6">
          {titleSection}
        </h2>
        <div className=" flex flex-col lg:flex-row">
          ...
          {/* Column Accordion */}
          <div className="w-full lg:w-8/12 flex flex-col gap-4 pt-4 lg:pt-0">
