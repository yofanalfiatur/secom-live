          ...
          {leftMenu.map(({ icon, text, href, subMenu }, index) => {
            ...
            return (
              <li className="relative header__type__item group" key={index}>
                <Link
                  href={href}
                  className={`flex flex-row py-[18px] gap-2 items-center justify-center relative header__type__link after:content-[''] after:bg-tosca after:h-[4px] after:w-0 after:absolute after:bottom-0 after:left-0 after:transition-all ease duration-300 hover:after:w-full ${
                    isActive ? "active-menu after:w-full" : ""
                  }`}
                >
                  ...
                  <div className="flex flex-col ease top-full absolute ease duration-300 invisible opacity-0 group-hover:visible group-hover:opacity-100 z-50 ">
                    ...
                    <ul className="bg-navyblue shadow-lg flex flex-col min-w-[210px] w-max submenu__type py-2">
                      {subMenu.map(({ subMenuText, subMenuHref }, subIdx) => {
                        const isSubMenuActive = isActiveLink(subMenuHref);
                        ...
                        return (
                          <li key={subIdx}>
                            ...
                            >
                              <p
                                className={`flex w-max hover:opacity-40 transition-all ease duration-200 cursor-pointer peer ${
                                  isSubMenuActive
            ...
            {rightMenu.map(({ text, href, subMenu }, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={href}
                    className={`relative py-5 header__menu__link flex flex-row items-center gap-2 after:content-[''] after:bg-tosca after:h-[4px] after:w-0 after:absolute after:bottom-0 after:left-0 after:transition-all ease duration-300 hover:after:w-full ${
                      isActive ? "active-menu after:w-full" : ""
                    }`}
                  >
