              ...
              <div className="w-full lg:w-2/3 flex flex-col ab-loc__embed">
                ...
                <div className="grid grid-cols-12 items-center bg-tosca pl-4 lg:pl-5 pr-4 lg:pr-8">
                  <div className="col-span-12 lg:col-span-8 gap-2 flex flex-col mt-3 mb-4">
                    <p
                      className="text-white text-sm leading-[1.7] mb-2 lg:mb-0"
                  ...
                  <div className="col-span-12 lg:col-span-4 flex flex-col lg:items-end mb-8 lg:mb-0">
                    <Link
                      ...
                      target="_blank"
                      className="text-tosca font-raleway text-xs lg:text-sm tracking-[2px] flex flex-row items-center h-max w-max gap-3 transition-all ease duration-200 relative bg-white py-4 pl-4 pr-8 rounded-[5px] hover:bg-navyblue hover:text-white group"
                    >
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="absolute top-1/2 right-[10px] transform -translate-y-1/2 transition-all ease duration-200"
                      >
                        <path
                          ...
                          fill="#00aaad"
                          className="transition-all ease duration-200 group-hover:fill-[#ffffff]"
                        />
                      </svg>
                    </Link>
                  </div>
